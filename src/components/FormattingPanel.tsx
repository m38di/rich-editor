...
export function FormattingPanel({ info, run, onOpenLink, onOpenDate, onOpenMath, onOpenInlineButtons }: FormattingPanelProps) {
  ...
  // pill 3 — math & reset
  const extras: Btn[] = [
    { key: 'btnrow', label: <Iv name="button" size={19} />, title: 'Inline buttons', onClick: onOpenInlineButtons },
