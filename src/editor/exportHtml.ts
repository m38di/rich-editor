...
/* ---------- inline buttons (official rich-HTML tags) ---------- */
tg-button-row {
  display: flex;
  flex-wrap: wrap;
  gap: 8px;
...
tg-button.style-default { background: rgba(26, 29, 33, .08); color: var(--ink); }
tg-button.style-primary { background: #229af0; color: #f8fcff; }
tg-button.style-danger { background: rgba(204, 80, 73, .14); color: #cc5049; }
tg-button.style-success { background: rgba(64, 169, 32, .13); color: #40a920; }
@media (prefers-color-scheme: dark) {
  tg-button.style-default { background: rgba(255, 255, 255, .09); color: var(--ink); }
  tg-button.style-primary { background: var(--accent); color: #07101f; }
  tg-button.style-danger { background: rgba(255, 99, 105, .16); color: #ff6369; }
  tg-button.style-success { background: rgba(62, 207, 127, .16); color: #3ecf7f; }
}
/* ---------- responsive ---------- */
